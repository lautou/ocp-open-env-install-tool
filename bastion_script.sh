...
mkdir _day2_generated
yq ".spec.source.repoURL = \"$GIT_REPO_BASE_URL/$GIT_REPO_PATH\"" day2_config/patch_templates/application-patch.yaml > _day2_generated/application-patch.yaml
